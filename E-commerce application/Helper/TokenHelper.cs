...
namespace E_commerce_application.Helper
{
    public static class TokenHelper
    {
        public async static Task<string> GenerateToken(string personId, string role)
        {
            ...
            var tokenKey = Encoding.UTF8.GetBytes("LongSecrectStringForModulekodestartppopouuutpopsdfjnshbvhueFGDKJSFBYJDSAGVYKDSGKFUYDGASYGFskc vhHJVCBYHVSKDGHASVBCL");
            //تجهيز claims 
